...
class CorporationsControllerTest < ActionController::TestCase
  ...
  test "should create corporation" do
    assert_difference('Corporation.count') do
      post :create, corporation: { incorporation_date: @corporation.incorporation_date, name: @corporation.name, par_value: @corporation.par_value, shares: @corporation.shares }
    end
  ...
  test "should update corporation" do
    put :update, id: @corporation, corporation: { incorporation_date: @corporation.incorporation_date, name: @corporation.name, par_value: @corporation.par_value, shares: @corporation.shares }
    assert_redirected_to corporation_path(assigns(:corporation))
  end
